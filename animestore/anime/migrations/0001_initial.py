    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='anime.category')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(to='anime.category')),
            ],
            options={
                'db_table': 'product',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='anime.order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='anime.product')),
            ],
            options={
                'db_table': 'orderitem',
            },
        ...
        migrations.AddField(
            model_name='order',
            name='ordered_items',
            field=models.ManyToManyField(through='anime.OrderItem', to='anime.product'),
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(default=1)),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='anime.cart')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='anime.product')),
            ],
            options={
                'db_table': 'cart_item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='root_category', to='anime.category')),
            ],
        ),
    ]
